...
parser.add_argument(
    "--data_folder_path", default="", help="data folder path", dest="data_folder_path"
)
...
for i in range(num_images):
    ...
    test_metrics_data = np.loadtxt(
        test_metrics_filename, delimiter="\t", comments="#", dtype=str
    )
...
image_level_statistics_filename = "{}/image_level_statistics_mpp.txt".format(
    data_folder_path
)
